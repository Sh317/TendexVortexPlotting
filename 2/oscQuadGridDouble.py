...
pos_ax.imshow(pos_grid, 'jet', norm=pos_norm)
pos_fig.savefig('plots/posGridDouble.png')
neg_fig.colorbar(cm.ScalarMappable(cmap='jet', norm = neg_norm), ax = neg_ax, label = 'eigenvalue')
neg_ax.imshow(neg_grid, 'jet', norm=neg_norm)
neg_fig.savefig('plots/negGridDouble.png')
