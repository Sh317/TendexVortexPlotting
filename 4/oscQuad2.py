...
# load C++
rka_iter = CDLL("./cppScripts/rka_iter").rka_iter_double
...
pos_fig.savefig('./plots/NoColor180Dpos_double_' + title + '.png', dpi=300)
neg_fig.savefig('./plots/NoColor180Dneg_double_' + title + '.png', dpi=300)