...
pos_norm = mcolors.Normalize(vmin=0, vmax=40)
neg_norm = mcolors.Normalize(vmin=0, vmax=40)
width = False
color = True
...
pos_fig.savefig('./plots/pos' + title + '.png', dpi=300)
neg_fig.savefig('./plots/neg' + title + '.png', dpi=300)